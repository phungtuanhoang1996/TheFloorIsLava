...
public class AssetLoader {
    ...
    public static TextureRegion background, player_dead_texture, player, scroll, clock, floor, button, player_1, player_2, player_3, player_4, bomb_1, bomb_2, bomb_3, bomb_4;
